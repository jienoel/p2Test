var p2DebugDraw = (function () {
    ...
    p.drawDistanceJoint = function (joint) {
    ...
    p.drawRevoluteJoint = function (joint) {
    ...
    p.drawGearJoint = function (joint) {
    ...
    p.drawPrismaticJoint = function (joint) {
        var pA = joint.bodyA.position;
        var pB = joint.bodyB.position;
        var anchorA = new Array(), anchorB = new Array();
    ...
    p.drawLockJoint = function (joint) {
    ...
    p.drawLinearSpring = function (spring) {
    ...
    p.drawRotationalSpring = function (spring) {
        var pA = new Array(), pB = new Array();
    ...
    p.drawHeightfeild = function (shape, b, color) {
    ...
    p.drawCapsule = function (shape, b, color) {
        var len = shape.length;
    ...
    p.drawCircleShape = function (shape, b, color, solid) {
        var offset = shape.position;
        var angle = shape.angle;
        var pos = new Array();
    ...
    p.drawPlaneShape = function (shape, b, color, fillColor) {
        var worldPoint = new Array();
        var worldVertices = new Array();
    ...
    p.drawVecAt = function (v, at, color, markStart) {
    ...
    p.drawVecTo = function (v, to, color, markStart) {
        if (markStart === void 0) { markStart = false; }
    ...
    p.drawSegment = function (start, end, color) {
    ...
    p.drawCircle = function (pos, radius, color, alpha, fillColor) {
    ...
    p.drawConvex = function (vertices, color, alpha, fillColor) {
        if (alpha === void 0) { alpha = 1; }
    ...
    p.toWorldVector = function (v, b) {
        var out = new Array();
        p2.vec2.rotate(out, v, b.angle);
        return out;
    };
    p.transformVec = function (v, offset, angle) {
        var nv = new Array();
        p2.vec2.rotate(nv, v, angle);
        p2.vec2.add(nv, nv, offset);
        return nv;
    };
    p.drawDotLine = function (vertices, color, smoothly, segmentLength) {
