var TestRevoluteConstraint = (function (_super) {
    __extends(TestRevoluteConstraint, _super);
    function TestRevoluteConstraint() {
        _super.call(this);
    }
    var d = __define,c=TestRevoluteConstraint;p=c.prototype;
    ...
    p.createJoint = function () {
        ...
        var joint = new p2.RevoluteConstraint(bodyA, bodyB, { worldPivot: [275 / this.factor, 100 / this.factor] });
    ...
    return TestRevoluteConstraint;
})(AbstractP2Test);
egret.registerClass(TestRevoluteConstraint,"TestRevoluteConstraint");
//# sourceMappingURL=TestRevoluteConstraint.js.map