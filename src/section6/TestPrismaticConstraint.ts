class TestPrismaticConstraint extends AbstractP2Test{
    ...
    private createJoint(): void {
        var bodyA: p2.Body = this.createRectangle(275, 100,60,80);
        ...
        var joint: p2.PrismaticConstraint = new p2.PrismaticConstraint(bodyA, bodyB,{disableRotationalLock:true});
