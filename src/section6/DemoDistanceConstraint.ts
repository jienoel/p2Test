class DemoDistanceConstraint extends AbstractP2Test{
    ...
    private createJoint(): void {
        var bodyA: p2.Body = this.createRectangle(275, 200, 100, 20);
        bodyA.fixedRotation = true;
        bodyA.fixedX = true;
        bodyA.updateMassProperties();
        var bodyB: p2.Body = this.createCircle(275, 300,30);
